...
export const InlineSentenceSelect = styled(Select)<{ $hasValue?: boolean }>`
  ...
  .ant-select-selector {
    ...
    border-color: ${props => props.$hasValue ? '#10b981' : '#cbd5e1'} !important;
    background: ${props => props.$hasValue ? '#ecfdf5' : '#ffffff'} !important;
    
    &:hover {
      border-color: ${props => props.$hasValue ? '#059669' : '#6366f1'} !important;
    }
  }
  ...
  .ant-select-selection-item {
    ...
    font-weight: ${props => props.$hasValue ? '700' : '600'} !important;
  }
  ...
  .ant-select-suffix {
    ...
    margin: 0 !important;
    color: ${props => props.$hasValue ? '#059669' : '#94a3b8'} !important;
