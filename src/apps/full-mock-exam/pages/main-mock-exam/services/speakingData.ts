...
export const part2Questions: ISpeakingQuestion[] = [
  {
    id: 4,
    questionText:
      "Describe this picture. Tell me what you can see in the photo.",
    sampleAnswers: [
  ...
  },
  {
    id: 5,
    questionText:
      "Why do you think it is important for families to cook or eat meals together?",
    sampleAnswers: [
...
export const part3Questions: ISpeakingQuestion[] = [
  {
    id: 7,
    questionText:
      "Compare these two pictures. What are the differences between them?",
    sampleAnswers: [
...
export const part4Questions: ISpeakingQuestion[] = [
  {
    id: 10,
    questionText:
      "Tell me about a time you had to make an important decision. What was the decision and why was it important? What was the outcome of your decision?",
    sampleAnswers: [
