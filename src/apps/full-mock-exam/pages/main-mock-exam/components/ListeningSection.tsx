...
export interface ListeningHandle {
    ...
    prefill: (answerData?: ListeningExamData) => void;
    atFirstUnit: () => boolean;
    atLastUnit: () => boolean;
}
