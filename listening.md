Part 1: Information Recognition (Xác định thông tin chi tiết)
Số lượng câu hỏi: 13 câu riêng biệt (tương ứng 13 audio ngắn).

Ngữ cảnh (Context): Tin nhắn thoại điện thoại, thông báo công cộng (sân bay, nhà ga), đoạn hội thoại rất ngắn giữa 2 người về đời sống hàng ngày.

Mục tiêu kiểm tra: Khả năng nghe và nắm bắt các thông tin cụ thể, con số, sự kiện.

Loại câu hỏi: Trắc nghiệm 3 lựa chọn (A, B, C).

Dấu hiệu nhận biết đáp án (Bẫy thường gặp): Người nói thường sẽ nhắc đến cả 3 thông tin xuất hiện trong A, B, C nhưng sẽ có từ phủ định hoặc thay đổi quyết định vào phút chót để làm nhiễu.
...
Mục tiêu kiểm tra: Khả năng hiểu ý chính và thái độ của từng người về chủ đề đó.
...
Mục tiêu kiểm tra: Khả năng nhận biết ai là người đưa ra ý kiến hoặc liệu cả hai có đồng ý với nhau không.

Loại câu hỏi: Đối với mỗi câu hỏi (là một nhận định), người học phải chọn 1 trong 3 đáp án:

Man (Chỉ người đàn ông đồng ý/nói ý này).

Woman (Chỉ người phụ nữ đồng ý/nói ý này).
...
Mục tiêu kiểm tra: Khả năng hiểu các mối quan hệ logic, mục đích của người nói, thái độ/quan điểm sâu xa và các chi tiết phức tạp (phải suy luận chứ không có sẵn từ khóa trong bài).

Loại câu hỏi: Trắc nghiệm 3 lựa chọn (A, B, C) cho mỗi câu hỏi.